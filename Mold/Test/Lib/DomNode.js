...
Seed({
		name : "Mold.Test.Lib.DomNode",
		dna : "test"
	},
	function(DomNode){
		describe("Test Mold.Lib.DomNode", function () {
			var flag = false;
			...
			it("create child node and append to node", function(){
				childNode = new DomNode(1, 'span');
				secondChildNode  = new DomNode(1, 'a');
				thirdChildNode = new DomNode(1, 'table')
			...
			it("add a attribute node", function(){
				attributNode = new DomNode(2, "style")
